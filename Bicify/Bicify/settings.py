"""
Django settings for Bicify project.
...
SECRET_KEY = 'django-insecure-b@(2hlie9igrl5=eho#x-)63l3)3*2^(^&&1dslumvhcav4_8m'
...
WSGI_APPLICATION = 'Bicify.wsgi.application'
